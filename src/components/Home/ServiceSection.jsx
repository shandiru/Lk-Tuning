...
const services = [
  {
    title: "DPF Solutions",
    desc: "Restore your vehicle's performance by cleaning or replacing the Diesel Particulate Filter (DPF) efficiently and safely.",
...

  {
    ...
    desc: "Keep your AdBlue system in top condition to reduce emissions and ensure your vehicle runs cleanly and efficiently.",
    image: "/tyres.avif",
  ...
  {
    title: "Wirl Flaps",
    desc: "Enhance your vehicle’s aerodynamics and performance with our professionally installed swirl flaps.",
    image: "/valeting.avif",
              ...
              >
                ...
                <div className="max-w-sm mx-auto">
                  <img
                    src={service.image}
                    alt={service.title}
                    className="absolute inset-0 w-[95%] mt-15 mx-auto h-40 object-cover"
                    onError={(e) => {
